...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="" style="text-decoration: none; color: #021659;">SANTOSH S YANNI</a></b>' 
    st.sidebar.markdown(link, unsafe_allow_html=True)
    st.sidebar.markdown('''
        <!-- site visitors -->

        <div id="sfc4tleyw8j48duc2m8r1ejb2zrk4ss6ude"></div>

        <noscript>
            <a href="https://www.freecounterstat.com" title="hit counter">
                <img src="https://counter4.optistats.ovh/private/freecounterstat.php?c=4tleyw8j48duc2m8r1ejb2zrk4ss6ude" border="0" title="hit counter" alt="hit counter"> -->
            </a>
        </noscript>
    
        <p>Visitors <img src="https://counter4.optistats.ovh/private/freecounterstat.php?c=4tleyw8j48duc2m8r1ejb2zrk4ss6ude" title="Free Counter" Alt="web counter" width="60px"  border="0" /></p>
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://www.linkedin.com/in/santosh-yanni-640600187?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" style="text-decoration: none; color: grey;">SANTOSH S YANNI. MCA ANGADI INSTITUTE OF TECHNOLOGY AND MANAGEMENT, BELGAUM</a> 
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin':
                ...
                st.success("Welcome Santosh S Yanni ! Total %d " % values + " User's Have Used Our Tool : )")                
